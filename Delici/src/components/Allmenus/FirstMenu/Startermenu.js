                    ...
                    <div className="row clearfix">
                        ...
                        <div className="menu-col col-lg-5 col-md-12 col-sm-12">
                            <div className="inner">
                                ...
                                <div className="dish-block">
                                    <div className="inner-box">
                                        <div className="title clearfix"><div className="ttl clearfix"><h5><Link to="#">Sours <span className="s-info">SEASONAL</span></Link></h5></div><div className="price"><span>13dt</span></div></div>
                                        <div className="text desc"><Link to="#">oranges , mandarin , lime ,mint optional : Honey</Link></div>
                                    </div>
                                </div>

                                <div className="dish-block">
                                    <div className="inner-box">
                                        <div className="title clearfix"><div className="ttl clearfix"><h5><Link to="#">Citrus Avocado Salad</Link></h5></div><div className="price"><span>13dt</span></div></div>
                                        <div className="text desc"><Link to="#">oranges , grapes, avocado .</Link></div>
                                    </div>
                                </div>

                                <div className="dish-block">
                                    <div className="inner-box">
                                        <div className="title clearfix"><div className="ttl clearfix"><h5><Link to="#">Summer Melon Salad <span className="s-info">SEASONAL</span></Link></h5></div><div className="price"><span>13dt</span></div></div>
                                        <div className="text desc"><Link to="#">watermelon,cantaloupe,blueberries, fresh mint leaves,honey.</Link></div>
                                    </div>
                                </div>
                            </div>
                        </div>
