...
function Contactbanner() {
  ...
  const handleSendMessage = async (e) => {
    e.preventDefault();
    try {
      await axios.post("http://localhost:7000/contact", {
        ...formData,
              ...
              <div className="row clearfix">
                ...
                <div className="contactinfo-block col-lg-4 col-md-4 col-sm-12">
                  ...
                  >
                    <h4>Contact Info</h4>
                    <div className="text">
                      Restaurant ; Nutribite , Tunisia <br />
                      Email: Nutribite@gmail.com
                    </div>
                    <div className="more-link">
                      <Link to="#">Booking: +216 21319930</Link>
                    </div>
                  </div>
                </div>
          ...
          <div className="c-page-form-box">
            <div className="row clearfix">
              <div className="loc-block col-lg-6 col-md-12 col-sm-12">
                ...
                <form className="default-form reservation-form" onSubmit={handleSendMessage}>
