...
import logo from '../../assets/images/resource/logo11.png'
...
// import{FaCartPlus} from 'react-icon'
                        ...
                        <ul className="navigation clearfix">
                            ...
                            <li className="dropdown"><Link to="/menu" onClick={() => setMenu(menu === true ? false : true)} >Menus<button type="button" className="btn-expander"><i className="far fa-angle-down"></i></button></Link>
                                <ul style={{ display: menu ? "block" : "none" }}>
                                    <li><Link to="/menuone">Fruit</Link></li>
                                    <li><Link to="/menutwo">Salads</Link></li>
                                    <li><Link to="/menuthree">Soups and Grills</Link></li>
                                    <li><Link to="/menufour">Whole Pack</Link></li>
                                </ul>
                            </li>
                            ...
                            <div className="inner clearfix">
                                <div className="top-left clearfix">
                                    <ul className="top-info clearfix">
                                        <li style={{color:"black"}}><i className="icon far fa-map-marker-alt" ></i> Nutribite,Tunisia,Marsa30 </li>
                                        <li style={{color:"black"}}><i className="icon far fa-clock"></i> Daily : 8.00 am to 10.00 pm</li>
                                    </ul>
                                </div>
                                <div className="top-right clearfix">
                                    <ul className="top-info clearfix">
                                        <li ><Link to="tel:+11234567890" style={{color:"black"}} ><i className="icon far fa-phone" style={{color:"black"}}></i> +216 21319930</Link></li>
                                        <li><Link to="mailto:booking@restaurant.com" style={{color:"black"}} ><i className="icon far fa-envelope" style={{color:"black"}}></i> Nutribite@gmail.com</Link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                                                    ...
                                                                    <div className="auto-container">
                                                                        <div className="row clearfix">
                                                                            ...
                                                                            <div className="menu-block col-lg-3 col-md-6 col-sm-6">
                                                                                ...
                                                                                <div className="title"><Link to="/menuthree">Grills and Soups</Link></div>
                                                                            </div>
                                                                            <div className="menu-block col-lg-3 col-md-6 col-sm-6">
